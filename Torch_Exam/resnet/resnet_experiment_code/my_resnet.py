...
class ResidualBlock(nn.Module):
    def __init__(self,inChannel, outChannel, stride = 1): # in, out, stride, 같은거 쓴다.
        ...
        torch.nn.init.kaiming_uniform_(self.conv1.weight)
        torch.nn.init.kaiming_uniform_(self.conv2.weight)
        torch.nn.init.kaiming_uniform_(self.conv1x1.weight)
...
class PlainNet(nn.Module):
    def __init__(self,version):
        ...
        self.layer1a = PlainBlock(channels[0], channels[0], 1)
        self.layer1b = PlainBlock(channels[0], channels[0], 1) # 32x32
        self.layer1c = PlainBlock(channels[0], channels[0], 1)
        self.layer1d = PlainBlock(channels[0], channels[0], 1)
        self.layer1e = PlainBlock(channels[0], channels[0], 1)
        self.layer1f = PlainBlock(channels[0], channels[0], 1)
        self.layer1g = PlainBlock(channels[0], channels[0], 1)
        self.layer1h = PlainBlock(channels[0], channels[0], 1)
        self.layer1i = PlainBlock(channels[0], channels[0], 1)

        self.layer2a = PlainBlock(channels[0], channels[1], 2) # 16x16
        self.layer2b = PlainBlock(channels[1], channels[1], 1)
        self.layer2c = PlainBlock(channels[1], channels[1], 1)
        self.layer2d = PlainBlock(channels[1], channels[1], 1)
        self.layer2e = PlainBlock(channels[1], channels[1], 1)
        self.layer2f = PlainBlock(channels[1], channels[1], 1)
        self.layer2g = PlainBlock(channels[1], channels[1], 1)
        self.layer2h = PlainBlock(channels[1], channels[1], 1)
        self.layer2i = PlainBlock(channels[1], channels[1], 1)

        self.layer3a = PlainBlock(channels[1], channels[2], 2) # 8x8
        self.layer3b = PlainBlock(channels[2], channels[2], 1)
        self.layer3c = PlainBlock(channels[2], channels[2], 1)
        self.layer3d = PlainBlock(channels[2], channels[2], 1)
        self.layer3e = PlainBlock(channels[2], channels[2], 1)
        self.layer3f = PlainBlock(channels[2], channels[2], 1)
        self.layer3g = PlainBlock(channels[2], channels[2], 1)
        self.layer3h = PlainBlock(channels[2], channels[2], 1)
        self.layer3i = PlainBlock(channels[2], channels[2], 1)
